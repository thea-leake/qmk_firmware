...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------------------------------------------------------|
     * |Ctrl|Fn0 |GUI |         Space          |ALT|Ctrl|FN0|FN1|
     * `--------------------------------------------------------'
     */
    [0] = LAYOUT(
        ...
        KC_LCTL, MO(1), KC_LGUI,                   KC_SPC,                             KC_RALT, KC_RCTL,   MO(1),               MO(2) \
    ),
    /* Layer 1: Second Layer
     * ,--------------------------------------------------------.
     * |`  | F1| F2| F3| F4| F5| F6| F7| F8| F9|F10|F11|F12|DEL||
     * |--------------------------------------------------------|
     * |Tab  |  Q|PGU|  E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]|\ |
     * |--------------------------------------------------------|
     * |Esc|VlD|PGD|VlU|  F|  G|Lef|Dow|Up |Rig|  ;|  '|Enter   |
     * |--------------------------------------------------------|
    ...
    [1] = LAYOUT(
        ...
        _______, KC__VOLDOWN,KC_PGDN, KC__VOLUP,  _______, _______, _______,  KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, _______,          _______,\
